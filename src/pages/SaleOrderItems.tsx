  ...
  return (
    <div>
      ...
      <div className="flex w-[90%] justify-center flex-col items-center mx-auto">
        ...
        <a
          href="/sale-order-items/new"
          className=" bg-blue-400 py-2 px-4 rounded-md mt-10 text-white hover:bg-blue-600 duration-300 transition-all"
        >
          Create New Item
        </a>
              ...
              items.map((item) => (
                <tr key={item.id}>
                  ...
                  <td className="border border-[#dddddd] padding-[8px] flex justify-around items-center">
                    <Link
                      to={`/sale-order-items/${item.id}/edit`}
                    ...
                    <button
                      ...
                      onClick={() =>
                        axios
                          .delete(
                            `http://localhost:3000/api/sale-order-items/${item.id}`,
                          )
                          .then(() =>
